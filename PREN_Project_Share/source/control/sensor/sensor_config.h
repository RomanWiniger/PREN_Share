...
#define SENSOR1_PULLUP				(1) 	// USR Config		// 1 = Pullup, 0 = Pulldown
...
#define SENSOR1_STATUS() 			((SENSOR1_GPIO_NAME->PDIR >> SENSOR1_REG) & 1)
...
#define SENSOR2_PULLUP				(1) 	// USR Config		// 1 = Pullup, 0 = Pulldown
...
#define SENSOR2_STATUS() 			((SENSOR2_GPIO_NAME->PDIR >> SENSOR2_REG) & 1)
...
#define SENSOR3_PULLUP				(1) 	// USR Config		// 1 = Pullup, 0 = Pulldown
...
#define SENSOR3_STATUS() 			((SENSOR3_GPIO_NAME->PDIR >> SENSOR3_REG) & 1)
