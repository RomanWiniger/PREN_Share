...
#define PRIO_UART2						   8  //Hinzugefügt
...
#define OnEnterUart2RxTxISR()                   LED_GREEN_FL_ON()  // <-- hinzugefügt
...
#define OnExitUart2RxTxISR()                    LED_GREEN_FL_OFF() // <-- hinzugefügt
...
#define OnEnterUart2RxTxISR()   // <-- hinzugefügt
#define OnEnterLpUart0ISR()

#define OnExitUart0RxTxISR()
#define OnExitUart1RxTxISR()
#define OnExitUart2RxTxISR()    // <-- hinzugefügt
