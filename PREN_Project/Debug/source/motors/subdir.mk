...
C_SRCS += \
../source/motors/motor.c 

C_DEPS += \
./source/motors/motor.d 

OBJS += \
./source/motors/motor.o 


# Each subdirectory must supply rules for building sources it contributes
source/motors/%.o: ../source/motors/%.c source/motors/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-motors

clean-source-2f-motors:
	-$(RM) ./source/motors/motor.d ./source/motors/motor.o

.PHONY: clean-source-2f-motors
